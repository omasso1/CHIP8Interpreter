...
constexpr int32_t PIXEL_SIZE = 13;
constexpr int32_t WINDOW_WIDTH = 64 * PIXEL_SIZE;
constexpr int32_t WINDOW_HEIGHT = 32 * PIXEL_SIZE;
constexpr int32_t NUMBER_OF_PIXELS = 32 * 64;
